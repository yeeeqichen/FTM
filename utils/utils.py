...
def get_neighbor_finder(data, uniform, max_node_idx=None, sample_mode='random', hard_sample=False):
    ...
    return NeighborFinder(adj_list, uniform=uniform, sample_mode=sample_mode, hard_sample=hard_sample)


class NeighborFinder:
    def __init__(self, adj_list, uniform=False, seed=None, sample_mode='random', hard_sample=False):
    ...
    def get_temporal_neighbor(self, source_nodes, timestamps, n_neighbors=20):
        ...
        for i, (source_node, timestamp) in enumerate(zip(source_nodes, timestamps)):
            ...
            if len(source_neighbors) > 0 and n_neighbors > 0:
                if self.sample_mode == 'random':  # if we are applying uniform sampling, shuffles the data above before sampling
